package com.al_tair.storage.operation.upload.product;
...
import com.al_tair.storage.exception.NotSameFileExpection;
import com.al_tair.storage.exception.UploadException;
import com.al_tair.storage.operation.upload.domain.UploadFile;
 ...
 * 该包用于存放各种方式上传实现，目前我们暂时只实现本地文件上传方式
 */
@Component
